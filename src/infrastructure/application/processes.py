...
# NOTE: This place is definitely should be replaced
...
def get(namespace: str, key: Any) -> Process:
    ...
    try:
        ...
        raise ProcessError(message=f"Process {_key} does not exist.") from err
...
def run(
    ...
    **kwargs: Any,
    ...
    if (_key := _build_key(namespace, key)) in _PROCESSES:
